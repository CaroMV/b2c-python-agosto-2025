...
-- Schema esquema_tacos
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `esquema_tacos` DEFAULT CHARACTER SET utf8mb3 ;
USE `esquema_tacos` ;
...
CREATE TABLE IF NOT EXISTS `esquema_tacos`.`tacos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `tortilla` VARCHAR(45) NULL DEFAULT NULL,
  `guiso` VARCHAR(45) NULL DEFAULT NULL,
  `salsa` VARCHAR(45) NULL DEFAULT NULL,
  `created_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
